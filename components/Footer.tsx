      ...
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 sm:mt-0">
            <SocialIcon href="#" path="M22.42 2.62a8.77 8.77 0 01-2.52.69 4.39 4.39 0 001.93-2.43 8.79 8.79 0 01-2.79 1.06 4.38 4.38 0 00-7.46 3.99A12.43 12.43 0 013.11 3.44a4.38 4.38 0 001.35 5.84 4.35 4.35 0 01-1.98-.55v.06a4.38 4.38 0 003.51 4.3 4.4 4.4 0 01-1.98.07 4.38 4.38 0 004.09 3.04 8.81 8.81 0 01-5.46 1.88A9.2 9.2 0 011 18.84a12.39 12.39 0 006.7 1.96c8.04 0 12.44-6.66 12.44-12.44 0-.19 0-.38-.01-.56a8.89 8.89 0 002.19-2.28z" />
            <SocialIcon href="#" path="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.09 15.59V12.7H8.59v-2.09h2.32v-1.57c0-2.3 1.4-3.57 3.46-3.57.99 0 1.84.07 2.09.11v1.98h-1.16c-1.12 0-1.33.53-1.33 1.3v1.74h2.59l-.34 2.09h-2.25v4.98h-2.48z" />
            <SocialIcon href="#" path="M16.17 10.17h-2.24v6.66h-2.2v-6.66h-1.24v-2.1h1.24v-1.47c0-1.56.88-2.52 2.63-2.52h1.47v2.1h-.9c-.66 0-.75.31-.75.75v1.19h1.69l-.23 2.1zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" />
          </div>
        </div>
      </div>
    </footer>
