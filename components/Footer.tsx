      ...
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <div className="text-sm text-gray-400">
            <span>&copy; {new Date().getFullYear()} BANT Confirm. All rights reserved.</span>
            <span className="mx-2">|</span>
            <button onClick={() => onNavigate('adminLogin')} className="hover:text-white transition-colors">Admin Panel</button>
          </div>
